...
export default class Fog extends Skyact.SkyactComponent {
  constructor(props) {
    super(props);
    this.ref = undefined;
  }
      ...
      <g class="climacon_wrapperComponent climacon_wrapperComponent-Fog">
        <path
          class="
            ...
            climacon_component-stroke_fogLine-top
          "
        ...
        <path
          class="
            ...
            climacon_component-stroke
            climacon_component-stroke_fogLine
            climacon_component-stroke_fogLine-middle
          "
        ...
        <path
          class="
            ...
            climacon_component-stroke
            climacon_component-stroke_fogLine
            climacon_component-stroke_fogLine-bottom
          "
