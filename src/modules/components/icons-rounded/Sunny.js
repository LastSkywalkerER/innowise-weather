...
export default class Sunny extends Skyact.SkyactComponent {
  constructor(props) {
    super(props);
    this.ref = undefined;
  }
        ...
        <g class="climacon_componentWrap climacon_componentWrap-sunSpoke">
          <path
            class="
              ...
              climacon_component-stroke_sunSpoke-east
            "
          ...
          <path
            class="
              ...
              climacon_component-stroke
              climacon_component-stroke_sunSpoke
              climacon_component-stroke_sunSpoke-northEast
            "
          ...
          <path
            class="
              ...
              climacon_component-stroke
              climacon_component-stroke_sunSpoke
              climacon_component-stroke_sunSpoke-northWest
            "
          ...
          <path
            class="
              ...
              climacon_component-stroke
              climacon_component-stroke_sunSpoke
              climacon_component-stroke_sunSpoke-west
            "
          ...
          <path
            class="
              ...
              climacon_component-stroke
              climacon_component-stroke_sunSpoke
              climacon_component-stroke_sunSpoke-southWest
            "
          ...
          <path
            class="
              ...
              climacon_component-stroke
              climacon_component-stroke_sunSpoke
              climacon_component-stroke_sunSpoke-south
            "
          ...
          <path
            class="
              ...
              climacon_component-stroke
              climacon_component-stroke_sunSpoke
              climacon_component-stroke_sunSpoke-southEast
            "
  ...
  render() {
    return Skyact.createElement('div', {
      className: 'saved-icon saved-icon--sunny',
      getRef: (ref) => {
        this.ref = ref;
      },
    });
