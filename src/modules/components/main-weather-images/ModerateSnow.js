...
export default class ModerateSnow extends Skyact.SkyactComponent {
  render() {
    ...
    return Skyact.createElement('div', null, [
      Skyact.createElement(
        ...
        [
          ...
          Skyact.createElement('img', {
            className: 'blob animation-snowflake animation-blob4',
            src: blob,
          }),
          Skyact.createElement('img', {
            className: 'blob animation-snowflake animation-blob5',
            src: blob,
          }),
          Skyact.createElement('img', {
            className: 'blob animation-snowflake animation-blob6',
            src: blob,
          }),
        ],
      ),
